...
#pragma mark - Open Knesset Mobile addition
-(void)setupMovie {
...
-(void)playMovie:(NSNotification *)notification {
    if (self.playerView.loadState == (MPMovieLoadStatePlayable | MPMovieLoadStatePlaythroughOK)) {
		...
		[self.playerView.view setFrame:((UIView *)[[[UIApplication sharedApplication] windows] lastObject]).frame];
        [[[[UIApplication sharedApplication] windows] lastObject] addSubview:self.playerView.view];
