 ...
 */
Analytics.prototype.startTrackerWithAccountID = function(accountId, successCallback, failureCallback) {
 ...
 * @param options			A JSON object with options. currently the only option is 'dispatch' 
 *							which causes an immediate dispatch
 * @param successCallback	The success callback
 * @param failureCallback	The error callback 
 */
Analytics.prototype.trackPageview = function(key, options, successCallback, failureCallback) {
	return PhoneGap.exec(
				successCallback,			
				failureCallback,		
				'GoogleAnalyticsTracker',
...
/**
 * Track a page view with custom variableon Google Analytics
 * @param successCallback	The success callback
 * @param failureCallback	The error callback 
 */
Analytics.prototype.setCustomVariable = function(slot, name, value, scope, successCallback, failureCallback) {
	return PhoneGap.exec(
				successCallback,			
				failureCallback,		
				'GoogleAnalyticsTracker',
...
PhoneGap.addConstructor(function() {
	PhoneGap.addPlugin('googleAnalyticsPlugin', new Analytics());
