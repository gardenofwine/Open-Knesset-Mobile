OKnesset.strings = {
	...
	infoDialog 				: {
		...
		AgendaDetailsView	: {
			title 			:"פרטי אג'נדה",
			text			:"מי המפלגה וחבר/ת הכנסת התומך/ת ביותר באג'נדה."
		},
		HomePage 			: {
			title 			:"ברוכים הבאים",
			text			:
'האפליקציה "כנסת פתוחה" היא חלק מפרוייקט שמטרתו לחשוף את פעילות הכנסת לציבור. </br><br/> \
<ul> \
...
<li>הפרויקט מבוסס כולו על מתנדבים, ולא נתמך ע"י אף גוף מפלגתי.</li>'
		...
		AgendaListView		: {
			title 			:"אג'נדות",
			text			:"מטרת האג'נדות היא לחשוף את מידת ההתאמה בין פועלו של ח\x22כ או מפלגה לבין אג'נדות שונות. <br> <b>שימו לב:</b> האג'נדות באתר מוגדרות ונערכות ע\x22י משתמשי האתר. לכן, הן אינן משקפות נתונים עובדתיים בלבד, אלא גם פרשנות מסוימת של הנתונים."
		},
		AgendaMembersSupportList : {
			title 			:"ברוכים הבאים",
			text			:"אנו מזמינים אתכם להכיר את חברי הכנסת שלכם טוב יותר."
		},
		AllCommittees		: {
			title 			:"ברוכים הבאים",
			text			:"אנו מזמינים אתכם להכיר את חברי הכנסת שלכם טוב יותר."
