OKnesset.strings = {
	...
	infoDialog 				: {
		Default 			: {
			title 			:"אופס...",
			text			:"אין כרגע פרטים אודות המסך הנוחכי. אנא שילחו לנו מייל משוב על ידי לחיצה על הכפתור"
		},
		AgendaDetailsView	: {
			title 			:"פרטי אג'נדה",
		...
		AgendaListView		: {
			title 			:"אג'נדות",
			text			:"מטרת האג'נדות היא לחשוף את מידת ההתאמה בין פועלו של ח\x22כ/מפלגה לבין אג'נדות שונות. <br> <b>שימו לב:</b> האג'נדות באתר מוגדרות ונערכות ע\x22י משתמשי האתר. לכן, הן אינן משקפות נתונים עובדתיים בלבד, אלא גם פרשנות מסוימת של הנתונים."
		},
